...
export const listWithThreePokeBalls = [
  {
    className:
      "absolute top-[-20px] right-[-100px] lg:top-20 lg:right-[-100px] opacity-10 h-60 w-60",
    id: 1,
  },
  {
    className:
      "absolute bottom-[-40px] left-[-80px] lg:left-[-40px] opacity-10 h-32 w-32",
    id: 2,
  },
  {
...
export const listWithFourPokeBalls = [
  {
    className:
      "absolute top-0 right-0 lg:top-[-100px] lg:right-[-50px] opacity-35 h-32 w-32",
    id: 1,
  },
  {
    className:
      "absolute bottom-[-30px] left-[-200px] lg:bottom-[-100px] lg:left-0 opacity-35",
    id: 2,
  },
  {
    className:
      "absolute top-[-30px] left-[-60px] lg:top-24 lg:left-0 opacity-35 h-52 w-52",
    id: 3,
  },
  {
    className:
      "absolute right-[-100px] lg:bottom-24 lg:right-[250px] opacity-35 h-52 w-52",
    id: 4,
  },
];
